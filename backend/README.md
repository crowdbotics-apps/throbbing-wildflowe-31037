...
## Project Structure
    ...
    ├── throbbing_wildflowe_31037  # Django project configurations
...
1. Clone this repo and `cd throbbing_wildflowe_31037`
...
2. Clone this repo and `cd throbbing_wildflowe_31037`
